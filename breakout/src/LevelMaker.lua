...
function LevelMaker.createMap(level)
    ...
    -- set random locked block for this level 
    local lockedX = math.random(numCols)
    local lockedY = math.random(numRows)
    ...
    for y = 1, numRows do
        ...
        for x = 1, numCols do
            ...
            -- 50% chance of adding in the locked block
            if (math.random(2) == 1) then                
                if (x == lockedX and lockedY == y) then 
                    b.locked = 1
                end
            end
